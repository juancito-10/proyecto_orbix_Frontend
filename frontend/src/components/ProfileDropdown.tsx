...
const ProfileDropdown = () => {
  ...
  const fallbackUser = fallbackUserStr ? JSON.parse(fallbackUserStr) : { nombre: 'Usuario', correo: '', rol: 'admin' };
  ...
  const roleColor = getRoleColor(displayData.rol);
      ...
      {isOpen && (
        <div className="profile-dropdown-menu">
            <div className="profile-dropdown-header">
              <div className="profile-dropdown-avatar" style={{ borderColor: roleColor, color: roleColor }}>{initials}</div>
              <div className="profile-dropdown-info">
                <h4 className="profile-dropdown-name">{displayData.nombre}</h4>
                <p className="profile-dropdown-role" style={{ color: roleColor, fontWeight: 'bold' }}>
                  {displayData.rol ? displayData.rol.charAt(0).toUpperCase() + displayData.rol.slice(1) : 'Rol no definido'}
                </p>
            ...
            <div className="cuenta-modal-header">
              ...
              {isEditing ? (
                <div style={{display:'flex', gap:'10px'}}>
                  <button className="profile-btn-save" onClick={handleSaveProfile} style={{ backgroundColor: roleColor }}>Guardar</button>
